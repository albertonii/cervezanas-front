...
const translationsEn = {
  ...
  fill_payment_shipping_details:
    "Complete your shipping and payment details below.",
  shipping_billing_information: "Shipping & Billing Information",
...
const translationsEs = {
  ...
  loading: "Cargando...",
  customer_cart: "Carrito de la compra",
  fill_payment_shipping_details: "Rellene los datos de envío y pago",
  shipping_billing_information: "Información de envío y facturación",
  ...
  address: "Dirección",
  address_extra: "Dirección (línea 2)",
