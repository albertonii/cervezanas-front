...
interface Props {
  ...
  handleShippingAddresses: (a: IShippingAddress) => void;
  billingAddresses: IBillingAddress[];
  handleBillingAddresses: (b: IBillingAddress) => void;
  handleOnClickShipping: (id: string) => void;
  handleOnClickBilling: (id: string) => void;
