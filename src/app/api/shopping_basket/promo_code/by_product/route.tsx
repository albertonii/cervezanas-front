...
export async function POST(request: NextRequest) {
    try {
            ...
            return NextResponse.json(
                {
                    isValid: false,
                    message:
                        'Este código promocional ya ha sido utilizado para este producto.',
                },
                { status: 400 },
            );
        }
        ...
        const discountValue = promoCode.discount_value;
        ...
        console.error(
            'Error al validar el código promocional - BY PRODUCT:',
            error,
        );
