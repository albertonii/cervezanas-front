...
export async function POST(request: NextRequest) {
    ...
    const res = await fetch('https://api.resend.com/emails', {
        ...
        body: JSON.stringify({
            ...
            to: emailTo,
            subject: '¡Has sido aceptado como DISTRIBUIDOR-TRANSPORTISTA!',
            html: `
                <!DOCTYPE html>
                    <html>
                    <head>
                    ...
                    <body>
                        <div class="container">
                            <div class="header">
                                ¡Bienvenido ${username}, ahora eres DISTRIBUIDOR!
                            </div>
                            <div class="content">

                                <p>
                                    ¡Enhorabuena! Desde Cervezanas nos complace anunciar que desde este momento puedes usar tu cuenta de perfil como si fueras un distribuidor
                                </p>
