                ...
                <article className="md:grid md:grid-cols-3 md:gap-8">
                  ...
                  <div className="col-span-2 mt-6 md:mt-0">
                    ...
                    <p className="mb-2 font-light text-gray-500 dark:text-gray-400">
                      ...
                      visiting Brasov city centre. It`s quite a while since we
                      are no longer using hotel facilities but self contained
                      places. And the main reason is poor cleanliness and staff
                      not being trained properly. This place exceeded our
                      expectation and will return for sure.
                    </p>
                    <p className="mb-5 font-light text-gray-500 dark:text-gray-400">
                      It is obviously not the same build quality as those very
                      expensive watches. But that is like comparing a Citroën to
                      a Ferrari. This watch was well under £100! An absolute
                      bargain.
                    </p>
