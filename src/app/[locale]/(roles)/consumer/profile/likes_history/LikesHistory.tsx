                  ...
                  <article className="md:grid md:grid-cols-3 md:gap-8">
                    ...
                    <div className="col-span-2 mt-6 md:mt-0">
                      <div className="mb-5 flex items-start">
                        <div className="pr-4">
                          ...
                          <h4 className="text-xl font-bold text-gray-900 dark:text-white">
                            Spotless, good appliances, excellent layout, host
                      ...
                      <p className="mb-2 font-light text-gray-500 dark:text-gray-400">
                        ...
                        anyone visiting Brasov city centre. It`s quite a while
                        since we are no longer using hotel facilities but self
                        contained places. And the main reason is poor
                        cleanliness and staff not being trained properly. This
