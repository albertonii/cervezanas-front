...
const PuntoCervezanasFlag = memo(function PuntoCervezanasFlag() {
        ...
        <section className="absolute right-0 top-10 rounded-l-lg bg-beer-dark sm:top-24 z-10">
            ...
            >
                <Image
                    ...
                    className={
                        'mx-2 my-2 w-10 rounded-full sm:mx-0 sm:my-0 sm:w-12'
                    }
                ...
                <div className="hidden sm:flex sm:flex-col">
                    ...
                    <span className="text-right text-beer-foam ">
                        Cervezanas
                    </span>
                </div>
            </Link>
...
export default PuntoCervezanasFlag;
