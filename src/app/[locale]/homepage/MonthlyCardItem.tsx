...
export default function MonthlyCardItem({ mProduct }: Props) {
    ...
    return (
        ...
        >
            <header className="relative flex flex-row justify-center rounded-t-lg  bg-cerv-coffee py-2 text-center font-semibold text-cerv-cream text-2xl">
                <h1>{product?.name}</h1>
            ...
            <footer className="mt-2 bg-cerv-coal p-1 text-center text-2xl font-bold text-cerv-cream hover:bg-cerv-titlehigh cursor-pointer">
                <Button
                    primary
                    class="w-full bg-cerv-coal border-0 hover:bg-cerv-titlehigh border-4 rounded-none"
                >
