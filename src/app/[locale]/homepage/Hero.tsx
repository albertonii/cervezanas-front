    ...
    <>
      ...
      <div className="flex justify-center bg-cerv-cream p-4 h-[220px] overflow-hidden relative border-gray-400 max-w-screen-2xl m-auto">
        <div className="flex w-full justify-center pt-1 border-double border-8 max-w-screen-2xl">
          <div className="w-[180px] h-[180px]  bg-[url('/assets/rec-graf1.png')] opacity-10 bg-cover bg-no-repeat bg-right relative left-0"></div>

          <div className=" justify-center lg:text-4xl text-center font-bold pt-7 inline-flex w-full">
            <div className="h-[170px] w-[170px] bg-[url('/assets/logo.svg')] bg-contain bg-no-repeat z-index-1  relative -left-12 -top-7
            "></div>
            <div className="">
              EL LUGAR DE ENCUENTRO PARA LOS AMANTES DE LA{" "}
              <div className="lg:text-5xl text-cerv-titlehigh">
                CERVEZA ARTESANA
              </div>
            </div>
          </div>
          <div className="w-[180px] h-[180px]  bg-[url('/assets/rec-graF2.png')] opacity-10 bg-cover bg-no-repeat relative right-0"></div>
        </div>
      </div>
      {/*  bloque 2 */}
      <div className="max-w-screen-2xl -top-12 relative m-auto">
        <img src="/assets/home/home-fakebanner.png"></img>
      </div>
      {/*  bloque 3 */}
      <div className="flex w-full justify-center max-w-screen-2xl -top-12 relative m-auto bg-cerv-cream p-5">
        <div className="w-1/4">
          <img src="/assets/home/home-img-1.jpg"></img>
        </div>
        <div className="w-1/4 p-10">
          ...
          <div className="text-cerv-titlehigh text-2xl font-bold text-center pt-3">
            Un punto de encuentro
          </div>
          <div className="pt-3 text-justify">
            La buena cerveza crea al artesano así como esta comunidad a
            Cervezanas. Creamos experiencias únicas para amantes de la música y
            la cerveza. Queremos que conozcas los experimentos cerveceros más
            locos, aquellas joyas escondidas y fabricadas con mimo para ti.
            Somos el puente entre aquellos fabricantes de cerveza artesanal aún
            por descubrir y tú.{" "}
          </div>
        </div>
        <div className="w-1/4">
          <img src="/assets/home/home-img-2.jpg"></img>
        </div>
        <div className="w-1/4 p-10">
          <div className="m-auto text-center">
            <img
      ...
      <div className="w-full justify-center max-w-screen-2xl -top-12 relative m-auto bg-cerv-titlehigh p-5">
        ...
        <div className="lg:text-5xl text-white font-bold relative z-10">
        ...
        <div className="text-cerv-cream w-8/12 pt-6 pb-6 relative z-10">
        ...
        <div className="w-8/12 flex">
          {/*  producto 1 */}
          <div className="bg-no-repeat w-1/3 mr-4">
          ...
          {/*  producto 3 */}
          <div className="bg-no-repeat w-1/3 relative z-10">
            <div className="bg-cerv-coffee text-cerv-cream font-semibold text-center">
              CERVEZAS SOTO
            </div>
      ...
      <div className="bg-[url('/assets/home/fondo-marcas.jpg')] bg-no-repeat bg-cover p-8 w-full justify-center max-w-screen-2xl relative m-auto pb-20">
        <div className="text-5xl text-cerv-coffee font-bold mb-8">
          ¿Quieres saber la historia detrás de cada marca?
        </div>
        <div className="bg-[url('/assets/home/botella-qr.png')] bg-no-repeat bg-right-top bg-contain w-[140px] h-[600px] absolute right-0 -top-6"></div>
        <div className="flex">
          <div className="bg-cerv-titlehigh bg-opacity-80 text-white p-7 w-1/2 mr-6 text-1xl pt-20">
            <div>
          ...
          <div className="bg-cerv-cream w-1/2 p-7 text-center pr-32">
      ...
      {/*  bloque 6 */}
      <div className="w-full justify-center max-w-screen-2xl relative m-auto pt-10 bg-cerv-cream pb-20">
        <div className="bg-[url('/assets/rec-graf4.png')] bg-no-repeat bg-cover opacity-10 w-[700px] h-[700px] absolute m-auto left-2/4 -ml-80"></div>
        <div className="text-cerv-coffee text-5xl text-center font-bold mb-10">
          Cervezas más vendidas
        </div>
        <div className="flex z-10 relative">
          {/*  producto 1 */}
          <div className="bg-no-repeat w-1/5 mr-4">
            <div className="bg-cerv-coffee text-cerv-cream font-semibold text-center">
              MÍSTICA
            </div>
      ...
      <div className="w-full justify-center max-w-screen-2xl relative m-auto pt-10 bg-cerv-cream pb-20 bg-[url('/assets/rec-graf5.png')] bg-contain">
        ...
        <div className="text-cerv-coffee text-6xl text-center font-bold mb-10">
        ...
        <div className="flex max-w-5xl m-auto">
          <div className="w-2/4">
            {" "}
            <img className="m-auto p-16" src="/assets/home/com-1.jpg"></img>
          </div>
        ...
        <div className="flex max-w-5xl m-auto">
          ...
          <div className="w-2/4">
            {" "}
            <img className="m-auto p-16" src="/assets/home/com-2.jpg"></img>
          </div>
        </div>
        {/*  Distribuidores */}
        <div className="flex max-w-5xl m-auto">
          <div className="w-2/4">
            {" "}
            <img className="m-auto p-16" src="/assets/home/com-3.jpg"></img>
          </div>
          <div className="m-auto w-2/4 p-10">
            <div className="text-cerv-banana text-4xl font-bold text-center pt-3 mb-8">
              Distribuidores
        ...
        <div className="flex max-w-5xl m-auto">
          ...
          <div className="w-2/4">
            {" "}
            <img className="m-auto p-16" src="/assets/home/com-4.jpg"></img>
          </div>
        </div>
      </div>
      {/*  bloque 7 */}
      <div className="w-full justify-center max-w-screen-2xl  relative m-auto bg-cerv-titlehigh p-5 overflow-hidden ">
        ...
        <div className="lg:text-4xl text-white font-bold text-center mb-20 mt-10">
          Opiniones de nuestros Cervezanos y Cervezanas
        </div>
        {/*  review 1 */}
        <div className="max-w-4xl m-auto bg-cerv-brown bg-opacity-70 px-10 pt-10 flex relative z-10">
          <div className="text-white w-1/4 border-b-2 pb-10 border-yellow-400">
            <div className="text-xs">01/01/2023</div>
            <div className="text-xl">Consumidor Cervezano</div>
          </div>
          <div className=" w-1/4 border-b-2  pb-10 border-yellow-400">
            <img
              className="m-auto"
              src="/assets/estrellas-fake.png"
              width="100"
          ...
          <div className="px-10 w-2/4 border-b-2 pb-10 border-yellow-400">
          ...
          <div className="text-white w-1/4 border-b-2 pb-10 border-yellow-400">
            <div className="text-xs">01/01/2023</div>
            <div className="text-xl">Productor Cervezano</div>
          </div>
          <div className=" w-1/4 border-b-2  pb-10 border-yellow-400">
            <img
              className="m-auto"
          ...
          <div className="text-white w-1/4 border-b-2 pb-10 border-yellow-400">
            <div className="text-xs">01/01/2023</div>
            <div className="text-xl">Creador de eventos</div>
          </div>
          <div className=" w-1/4 border-b-2  pb-10 border-yellow-400">
            <img
              className="m-auto"
