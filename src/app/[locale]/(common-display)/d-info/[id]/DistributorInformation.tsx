    ...
    return (
        <section className="no-wrap container mx-auto my-5 p-5 md:-mx-2 md:flex">
            ...
            <div className="w-full md:mx-2 md:w-3/12">
                {/*  Profile Card  */}
                <header className="rounded-md border-t-4 border-beer-gold bg-white p-3 shadow-md">
            ...
            <div className="mx-2 h-64 w-full md:w-9/12">
                ...
                <div className="rounded-sm bg-white p-3 shadow-sm">
                    <figure className="flex items-center space-x-2 font-semibold leading-8 text-gray-900">
                        <span className=" text-beer-gold">
                            <svg
                                className="h-5"
                                xmlns="http://www.w3.org/2000/svg"
