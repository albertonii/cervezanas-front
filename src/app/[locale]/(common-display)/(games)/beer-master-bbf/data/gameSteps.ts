export const gameSteps = [
    {
        ...
        title: 'Los Orígenes',
        description:
            'Descubre la historia de la cerveza artesanal en Catalunya',
        ...
        correctAnswers: 0,
        timeSpent: 0, // Tiempo en milisegundos
        questions: [
            {
                id: 1,
                ...
                correctAnswer: 1,
                explanation:
                    'La primera cervecería artesanal de Barcelona abrió sus puertas en 1992, coincidiendo con los Juegos Olímpicos.',
                difficulty: 'easy',
                points: 100,
            },
            {
                ...
                correctAnswer: 0,
                explanation:
                    'La Pale Ale fue el primer estilo producido, inspirado en las cervezas británicas.',
                difficulty: 'medium',
                points: 150,
            },
            {
                ...
                correctAnswer: 2,
                explanation:
                    'El BBF 2012 marcó un antes y después en la cultura cervecera artesanal catalana.',
                difficulty: 'hard',
                points: 200,
            },
        ],
        ...
        questions: [
            {
                ...
                correctAnswer: 1,
                explanation:
                    'El rango de 15-20°C es ideal para la germinación controlada del grano.',
                difficulty: 'medium',
                points: 150,
            },
            {
                ...
                correctAnswer: 1,
                explanation:
                    'La cebada es el cereal más utilizado por su alto contenido en enzimas y almidón.',
                difficulty: 'easy',
                points: 100,
            },
            {
                ...
                correctAnswer: 2,
                explanation:
                    'El proceso completo requiere 6-7 días para un malteado óptimo.',
                difficulty: 'hard',
                points: 200,
            },
        ],
        ...
        questions: [
            {
                ...
                correctAnswer: 1,
                explanation:
                    'El lúpulo Cascade es famoso por sus distintivas notas cítricas y florales.',
                difficulty: 'medium',
                points: 150,
            },
            {
                ...
                correctAnswer: 2,
                explanation:
                    'El Saaz es un lúpulo noble originario de la República Checa.',
                difficulty: 'hard',
                points: 200,
            },
        ],
        ...
        questions: [
            {
                ...
                correctAnswer: 3,
                explanation:
                    'El Sahti finlandés es considerado uno de los estilos más antiguos aún producidos.',
                difficulty: 'hard',
                points: 200,
            },
        ],
        ...
        questions: [
            {
                ...
                correctAnswer: 2,
                explanation:
                    'El Barleywine complementa perfectamente la intensidad de los quesos azules.',
                difficulty: 'hard',
                points: 200,
            },
        ],
        ...
        questions: [
            {
                ...
                correctAnswer: 3,
                explanation:
                    'Las cervecerías modernas pueden reutilizar hasta el 90% del agua mediante sistemas cerrados.',
                difficulty: 'hard',
                points: 200,
            },
        ],
