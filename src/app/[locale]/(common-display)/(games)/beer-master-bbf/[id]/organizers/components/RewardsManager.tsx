            ...
            <div className="flex justify-between items-center">
                <div>
                    ...
                    <p className="text-gray-600 mt-1">
                        Configura las recompensas que los participantes pueden
                        ganar
                    </p>
                </div>
                <Button primary medium onClick={() => setShowAddForm(true)}>
                    Añadir Recompensa
                </Button>
            </div>
                                ...
                                <div>
                                    ...
                                    <div className="mt-2 flex items-center space-x-4 text-sm">
                                        ...
                                        <span className="text-gray-500">
                                            ...
                                            {reward.condition.correctAnswers}/
                                            {reward.condition.totalQuestions}{' '}
                                            respuestas
                                        </span>
                                        <span className="text-gray-500">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-4">
                            ...
                            <div>
                                ...
                                >
                                    ...
                                    <option value="2">
                                        Paso 2: El Arte del Malteado
                                    </option>
                                    <option value="3">
                                        Paso 3: Lúpulos del Mundo
                                    </option>
                                </select>
                            </div>
                            ...
                            <div className="flex justify-between space-x-3 pt-4">
                                <Button primary small btnType="submit">
                                    Guardar Recompensa
                                </Button>
                                <Button
                                    accent
