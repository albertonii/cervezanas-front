                        ...
                        <div className="text-gray-700">
                            <div className="grid text-sm md:grid-cols-2">
                                <div className="grid grid-cols-2">
                                    ...
                                    {/* <div className="px-4 py-2">{consumer.name}</div> */}
                                    <div className="px-4 py-2">NOMBRE</div>
                                </div>
                                <div className="grid grid-cols-2">
                                    <div className="px-4 py-2 font-semibold">
                                        {t('lastname')}
                                    </div>
                                    {/* <div className="px-4 py-2">{consumer.lastname}</div> */}
                                    <div className="px-4 py-2">APELLIDO</div>
                                </div>
                                ...
                                {/* {consumer..profile_location && (
                  <address className="grid grid-cols-2">
                    <div className="px-4 py-2 font-semibold">
                      {t("address")}
                    </div>
                    <div className="px-4 py-2">
                      {consumer.profile_location[0].address_1 ??
                        "" + " " + consumer.profile_location[0].address_2 ??
                        ""}

                      <br />

                      {consumer.profile_location[0].city ??
                        "" + ", " + consumer.profile_location[0].province ??
                        "" + ", " + consumer.profile_location[0].country ??
                        ""}

                      <br />

                      {consumer.profile_location[0].postalcode ?? ""}
                    </div>
                  </address>
                )} */}
