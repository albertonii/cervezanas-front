...
export default function EventCart({ eventId }: Props) {
    ...
    return (
        ...
        >
            <section
                className="sticky max-w-[80vw] sm:max-w-full z-40 rounded-lg border border-beer-softBlonde bg-white dark:bg-gray-800 dark:border-gray-700 shadow-lg transition-colors duration-300"
                aria-modal="true"
                role="dialog"
                tabIndex={-1}
