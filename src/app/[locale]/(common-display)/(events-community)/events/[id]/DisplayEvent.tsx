...
export default function DisplayEvent({
    ...
    return (
        <section className="relative m-auto sm:mb-20 sm:mt-20 h-full w-full max-w-[500px] bg-white p-8 shadow-md sm:max-w-full md:mt-0 md:max-w-[700px] lg:max-w-[900px] bg-opacity-80 space-y-4 dark:bg-cerv-titlehigh">
            ...
            <h2 className="mb-4 text-lg text-gray-500 dark:text-white">{event.description}</h2>
