        ...
        <section className="h-full space-y-8 p-2 bg-white bg-[url('/assets/maestro/mestro-fondo.webp')] bg-cover bg-no-repeat px-8 sm:px-32 pb-16">
            ...
            <section className="m-auto bg-cerv-coal bg-opacity-50 p-8 text-white">
                ...
                <p className="text-base text-justify max-w-full">
                    ...
                    decida la empresa organizadora (Cervezanas M&M S.L.)
                    utilizando un sistema al azar para la selección de los
                    premiados y de los suplentes. Cuando un participante haya
                    sido premiado será excluido del sorteo de los sucesivos
                    premios que falten por sortear. Una vez elegidos los
                    ganadores se les comunicará por correo electrónico su
                    premio. Si en el plazo de 15 días desde el envío del correo
                    no hemos recibido respuesta el premio pasará al primer
                    suplente disponible en la lista.
                </p>
            </section>
        </section>
    );
