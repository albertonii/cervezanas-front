...
export default function ProductDetails({ product, reviewRef }: Props) {
  ...
  return (
    <>
      <section className="aspect-w-2 aspect-h-3 col-span-12 mx-6 flex h-[100%] items-center justify-center rounded-lg bg-beer-softBlonde bg-[url('/assets/madera.jpg')] bg-cover bg-top bg-repeat-y md:overflow-hidden lg:col-span-4">
        <ProductGallery
          gallery={gallery}
          isLike={isLike}
      ...
      <section className="col-span-12 mx-6 space-y-4 bg-[url('/assets/rec-graf2b.png')] bg-auto bg-center bg-no-repeat lg:col-span-8">
