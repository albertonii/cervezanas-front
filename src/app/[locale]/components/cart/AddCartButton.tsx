    ...
    return (
        <div className="relative group">
            ...
            <IconButton
                ...
                classContainer="text-base lg:text-lg text-left transform transition-transform group-hover:scale-105 group-hover:shadow-lg group-hover:outline group-hover:outline-1 group-hover:outline-white group-hover:outline-offset-[-3px] w-full"
