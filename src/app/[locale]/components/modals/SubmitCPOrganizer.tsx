...
export function SubmitCPOrganizer({ handleCPOrganizerStatus }: Props) {
    ...
    const onSubmit = (form: FormData) => {
        ...
        const submitCPOrganizer = async () => {
            const coverLetterName = normalizeFileName(
                    ...
                    <fieldset className="flex flex-col space-y-2">
                        ...
                        <div className="flex flex-col space-y-2">
                            ...
                            <span className="text-sm text-gray-500">
                                {t(
                                    'form_submit_cp_organizer_cover_letter_description',
                                )}
                            </span>
                            ...
                            {errors.cover_letter_file && (
                                <DisplayInputError
                                    message={errors.cover_letter_file.message}
                                />
                            )}
                        </div>
                        ...
                        <div className="flex flex-col space-y-2">
                            ...
                            {errors.cv_file && (
                                <DisplayInputError
                                    message={errors.cv_file.message}
                                />
                            )}
                        </div>
                    </fieldset>
