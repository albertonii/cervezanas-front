...
const Button = memo(function PaginationFooter({
    ...
    return (
        ...
        justify-center rounded border-2 border-beer-blonde py-2 transition duration-100 ease-in focus:outline-none focus:ring focus:ring-beer-softFoam uppercase
        ${getSizeClass()}
        ${getColorClass()}
        ${box ? 'h-auto w-10' : ''}
