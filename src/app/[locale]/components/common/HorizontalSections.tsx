...
export default function HorizontalSections({ handleMenuClick, tabs }: Props) {
    ...
    return (
        <>
          ...
          active flex w-full items-center justify-center p-4 hover:cursor-pointer hover:bg-gray-50 hover:text-beer-draft focus:outline-none focus:ring-4 focus:ring-beer-blonde dark:bg-gray-700 dark:text-white uppercase font-semibold shadow-xl border-2 hidden`}
