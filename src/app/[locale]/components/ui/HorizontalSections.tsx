            ...
            <ul className="mx-14 sm:mx-16 block sm:flex justify-center bg-white rounded-lg shadow-md overflow-hidden border-2 border-gray-300">
                {tabs.map((tab, index) => (
                    <li
                        key={index}
                        className={`
                            flex-1 text-center text-xs md:text-sm xl:text-base px-4 py-3 cursor-pointer font-semibold uppercase transition-colors duration-300 hover:text-beer-blonde
                            ${
                                activeTab === tab
