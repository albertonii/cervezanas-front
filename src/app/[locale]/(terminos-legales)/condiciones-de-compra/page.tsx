        ...
        <div className="container m-auto my-16 w-[1200px] m-auto bg-white border-4 border-beer-blonde p-11 max-w-full">
            <div className="m-auto space-y-12">
                ...
                <div>
                    ...
                    estas condiciones. Al utilizar esta página web o hacer un
                    pedido a través de la misma el usuario acepta nuestros
                    TÉRMINOS Y CONDICIONES DE COMPRA así como nuestra POLÍTICA
                    DE PRIVACIDAD, por lo que, en caso de no estar de acuerdo,
                    no debe utilizar la web.
                </div>
                ...
                <section className="">
                    ...
                    <div>
                        ...
                        Electrónico le informamos que la titularidad de la web
                        corresponde a Cervezanas M&M S.L. con CIF: B88139878 y
                        domicilio sito en la Calle Cañón del Río Lobos 7C, 1ºA
                        de Madrid y con correo electrónico info@cervezanas.eu,
                        en adelante CERVEZANAS.
                    </div>
                </section>
                ...
                <section>
                    ...
                    <div>
                        ...
                        recabados por la navegación o contratación de servicios
                        a través de la política de privacidad. Puede acceder a
                        la política de privacidad desde la página web en
                        cualquier momento.
                    </div>
                </section>
                ...
                <section>
                    ...
                    <div>
                        ...
                        una dirección dentro del territorio español como a un
                        destino europeo.
                    </div>
                </section>
                ...
                <section>
                    ...
                    <div>
                        ...
                        en stock, CERVEZANAS informará al cliente de tal
                        circunstancia, bien por mail o por teléfono y
                        reembolsará cualquier cantidad que hubiese abonado por
                        el producto o productos no disponibles o cambiará el
                        producto por otro del mismo valor, según decida el
                        cliente.
                    </div>
                </section>
                ...
                <section>
                    ...
                    <div>
                        ...
                        CERVEZANAS se reserva el derecho a modificar los precios
                        en cualquier momento, si bien los productos se
                        facturarán sobre la base del precio en vigor en el
                        momento de formalizar el pedido (a reserva de la
                    ...
                    <div>
                        ...
                        37/1992, sin perjuicio de la aplicación de los impuestos
                        y aranceles correspondientes conforme a la normativa
                    ...
                    <div>
                        ...
                        verificación antes de formalizar la misma.
                    </div>
                </section>
                ...
                <section>
                    ...
                    <div>
                        ...
                        la compra. El siguiente paso será tramitar el pedido y
                        efectuar el pago. Para ello deberá seguir los pasos que
                        se le solicitan en la página web y seguir las
                        indicaciones de compra que le aparecen en pantalla. Se
                        le pedirán únicamente los datos necesarios para la
                        compra y posterior entrega del pedido. Antes de
                        formalizar la compra deberá ACEPTAR EXPRESAMENTE las
                        presentes condiciones así como la política de
                        privacidad.
                    </div>
                    ...
                    <div>
                        ...
                        ocurrirá cuando haya efectuado el pago. Hacer “clik” en
                        “Pagar” implica que adquiere y abona los artículos
                        seleccionados, este paso supone un compromiso
                        vinculante.
                    </div>
                ...
                <section>
                    ...
                    <div>
                        ...
                        envío que correspondan según el caso, se cargarán en la
                    ...
                    <div>
                        ...
                        tarjeta) se cancelará el pedido de forma automática. El
                        sistema de pago mediante tarjeta bancaria se realiza a
                        través de la pasarela de pago gestionada por Getnet
                        Europe.
                    </div>
                    ...
                    <div>
                        ...
                        se codificarán los datos de su tarjeta de crédito. Las
                        tarjetas de crédito estarán sujetas a comprobaciones y
                        autorizaciones por parte de la entidad emisora de las
                        mismas, pero si dicha entidad no autorizase el pago, el
                        pedido será cancelado automáticamente, informando el
                    ...
                    <div>
                        ...
                        se reserva el derecho a no enviar el pedido hasta su
                        total abono por parte del cliente.
                    </div>
                </section>
                ...
                <section>
                    ...
                    <div>
                        ...
                        pudiésemos cumplir con la fecha de entrega, le
                        informaremos de esta circunstancia y le daremos la
                        opción de seguir adelante con la compra estableciendo
                        una nueva fecha de entrega o bien anular el pedido con
                    ...
                    <div>
                        ...
                        indicado por usted adquiera la posesión material de los
                        productos, lo que se acreditará mediante la firma de la
                        recepción del pedido en la dirección de entrega
                        convenida.
                    </div>
                </section>
                ...
                <section>
                    ...
                    <div>
                        ...
                        su entrega en una fecha posterior. Para ello le rogamos
                        que si no va a estar en el domicilio se ponga en
                        contacto con CERVEZANAS para convenir la entrega otro
                        día.
                    </div>
                    ...
                    <div>
                        ...
                        entenderemos que desea desistir del contrato y lo
                    ...
                    <div>
                        ...
                        indebida y, en cualquier caso, en el plazo máximo de 14
                        días desde la fecha en que consideremos resuelto el
                        contrato. Por favor, tenga en cuenta que el transporte
                        derivado de la resolución puede tener un coste
                        adicional, por lo que CERVEZANAS estará autorizado a
                        repercutirle los costes correspondientes.
                    </div>
                </section>
                ...
                <section>
                    ...
                    <div>
                        ...
                        posesión material de los bienes o en caso de que los
                        productos que componen el pedido se entreguen por
                        separado, a los 14 días naturales del día que el cliente
                        o un tercero indicado por el cliente, distinto del
                        transportista, adquirió la posesión material del último
                    ...
                    <div>
                        ...
                        Por favor, tenga en cuenta que si usted decide
                        devolvernos los artículos a portes debidos estaremos
                        autorizados a cargarle los gastos en que podamos
                        incurrir.
                    </div>
                    ...
                    <div>
                        ...
                        se hará ningún reembolso si el producto ha sido usado
                        más allá de la mera apertura del mismo, de productos que
                        no estén en las mismas condiciones en las que se
                        entregaron o que hayan sufrido algún daño, por lo que
                        deberá ser cuidadoso con el/los producto/s mientras
                        estén en su posesión. Por favor, devuelva el artículo
                        usando o incluyendo todos sus envoltorios originales con
                        todas las etiquetas. Rogamos no retiren las etiquetas
                        hasta estar seguros de querer quedarse con cada
                        artículo.
                    </div>
                    ...
                    <div>
                        ...
                        importe total de la compra más los gastos de envío en un
                        plazo de 14 días desde que recibamos el pedido
                        cancelado.
                    </div>
                    ...
                    <div>
                        ...
                        de los productos devueltos, sin los gastos de envío.
                    </div>
                </section>
                ...
                <section>
                    ...
                    <div>
                        ...
                        productos, junto con los gastos de envío derivados y de
            ...
            <div className="m-auto space-y-12">
                ...
                <section>
                    <ul>
                        ...
                        <li>
                            ...
                            proceda de otras fuentes ajenas.
                        </li>
                    </ul>
                    ...
                    <div>
                        ...
                        cualquier pérdida de beneficios, pérdida de negocios,
                        interrupción de negocios o pérdida de oportunidades
                ...
                <section>
                    ...
                    <div>
                        ...
                        podrá transmitir, ceder, gravar o de cualquier otro modo
                        transferir un contrato o alguno de los derechos u
                        obligaciones derivados del mismo, sin haber obtenido el
                    ...
                    <div>
                        ...
                        cualquier momento durante su vigencia. Para evitar
                        cualquier duda, dichas transmisiones, cesiones,
                        gravámenes u otras transferencias no afectarán los
                        derechos que, en su caso, usted, como consumidor, tiene
                        reconocidos por ley ni anularán, reducirán o limitarán
                        de cualquier otra forma las garantías, tanto expresas
                        como tácitas, que le hubiésemos podido otorgar.
                    </div>
                </section>
                ...
                <section>
                    ...
                    <div>
                        ...
                        CERVEZANAS tenga control alguno sobre el contenido de
                        dichas páginas web o materiales. Por lo tanto, no
                        aceptamos responsabilidad alguna por cualquier daño o
                    ...
                    <div>
                        ...
                        de acuerdo con las modificaciones introducidas, le
                        recomendamos no hacer uso de nuestra página web.
                    </div>
                </section>
                ...
                <section>
                    ...
                    <div>
                        ...
                        cualquier otro programa o material tecnológicamente
                        perjudicial o dañino. El usuario no tratará de tener
                        acceso no autorizado a esta página web, al servidor en
                        que dicha página se encuentra alojada o a cualquier
                        servidor, ordenador o base de datos relacionada con
                        nuestra página web. El usuario se compromete a no atacar
                        esta página web. El incumplimiento de esta cláusula
                        podría llevar aparejada la comisión de infracciones
                        tipificadas por la normativa aplicable. Informaremos de
                        cualquier incumplimiento de dicha normativa a las
                        autoridades competentes y cooperaremos con ellas para
                        descubrir la identidad del atacante. Asimismo, en caso
                        de incumplimiento de la presente cláusula, dejará
                        inmediatamente de estar autorizado a usar esta página
                        web. No seremos responsables de cualquier daño o pérdida
                        resultante de un ataque de denegación de servicio, virus
                        o cualquier otro programa o material tecnológicamente
                        perjudicial o dañino que pueda afectar a su ordenador,
                        equipo informático, datos o materiales como consecuencia
                        del uso de esta página web o de la descarga de
                        contenidos de la misma o a los que la misma
                        redireccione.
                    </div>
                </section>
                ...
                <section>
                    ...
                    <div>
                        ...
                        contenidos que se aportan como parte de la página web
                        corresponden en todo momento a CERVEZANAS. El usuario
                        podrá hacer uso de dicho material únicamente en la forma
                        en que se le autorice expresamente.
                    </div>
                </section>
                ...
                <section>
                    ...
                    <div>
                        ...
                        guarde relación con el uso de la página web o con dichos
                        contratos será sometida a la jurisdicción exclusiva de
