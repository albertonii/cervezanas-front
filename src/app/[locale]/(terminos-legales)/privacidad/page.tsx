        ...
        <div className="container m-auto my-16 w-[1200px] m-auto bg-white border-4 border-beer-blonde p-11 max-w-full">
            <div className="m-auto space-y-12">
                ...
                <section className="">
                    <div>
                        ...
                        casos, es necesario recabar información para
                    ...
                    <div>
                        ...
                        circulación de estos datos, y la LEY 34/2002, de 11 de
                        julio, de Servicios de la Sociedad de la información y
                        de comercio electrónico (en adelante, “LSSI”),
                        CERVEZANAS informa al usuario que, como responsable del
                        tratamiento, incorporará los datos de carácter personal
                    ...
                    <div>
                        ...
                        <ul>
                            ...
                            <li>
                                ...
                                cumpliendo la normativa, y cuando sea necesario,
                ...
                <section className="">
                    ...
                    <div>
                        ...
                        personales, puedes ponerte en contacto con él mediante
                        el correo info@cervezanas.eu
                    </div>
                </section>
                ...
                <section className="">
                    ...
                    <div>
                        ...
                        facilitar los datos personales solicitados o el no
                        aceptar la presente política de protección de datos
                        supone la imposibilidad de suscribirse, registrarse o
                        participar en cualquiera de las promociones en las que
                ...
                <div>
                    <ul>
                        ...
                        <li>
                            ...
                            personales de facturas, contratos y documentos para
                            responder a reclamaciones de clientes o de las
            ...
            <section className="">
                ...
                <div>
                    ...
                    relación comercial), así como para el cumplimiento de las
                    obligaciones legales que se deriven del tratamiento de los
                    datos.
                </div>
            </section>
            ...
            <section className="">
                ...
                <div>
                    ...
                    servicios externos con los que CERVEZANAS trabaje pueden
                    usar los datos para proporcionar los servicios
                    correspondientes, sin embargo no usarán dicha información
                ...
                <div>
                    ...
                    confidencialidad y cuentan con las medidas adecuadas para
                    proteger los datos personales. Dichos terceros tienen la
                    obligación de garantizar que la información se trata
            ...
            <section className="">
                ...
                <div>
                    ...
                    protección suficiente, ya sea porque se trate de países
                    considerados seguros o porque cuentan con Normas
                ...
                <div>
                    ...
                    <ul>
                        ...
                        <li>
                            ...
                            que produzca efectos jurídicos o afecte
            ...
            <section className="">
                ...
                <div>
                    ...
                    vigencia y autenticidad de los datos personales facilitados,
                    y se comprometen a mantenerlos debidamente actualizados. El
                    usuario acepta proporcionar información completa y correcta
                    en el formulario de registro o suscripción. CERVEZANAS se
                    reserva el derecho de finalizar los servicios contratados
                    que se hubiera celebrado con los usuarios, en caso de que
                    los datos que haya facilitado sean falsos, incompletos,
                ...
                <div>
                    ...
                    en cuanto a hipotéticos perjuicios que pudieran originarse
                ...
                <div>
                    ...
                    información. Se exonera a CERVEZANAS de responsabilidad ante
                    cualquier daño o perjuicio que pudiera sufrir el usuario
                    como consecuencia de errores, defectos u omisiones, en la
                    información facilitada por CERVEZANAS. siempre que proceda
            ...
            <section className="">
                ...
                <div>
                    ...
                    catorce años, de conformidad con el artículo 8 del RGPD y el
                    artículo 7 de la LO 3/2018, de 5 de diciembre (LOPDGDD),
                    CERVEZANAS exigirá el consentimiento válido, libre,
                    inequívoco, específico e informado de sus tutores legales
                    para tratar los datos personales de los menores. En este
                    caso, se exigirá el DNI u otra forma de identificación de
            ...
            <section className="">
                ...
                <div>
                    ...
                    alteración, acceso no autorizado y robo de los Datos
                ...
                <div>
                    ...
                    telefónicas o desconexiones en el funcionamiento operativo
                    de este sistema electrónico, motivadas por causas ajenas a
                    CERVEZANAS; de retrasos o bloqueos en el uso del presente
                    sistema electrónico causados por deficiencias o sobrecargas
                    de líneas telefónicas o sobrecargas en el Centro de Procesos
                    de Datos, en el sistema de Internet o en otros sistemas
                    electrónicos, así como de daños que puedan ser causados por
                    terceras personas mediante intromisiones ilegítimas fuera
                    del control de CERVEZANAS. Ello no obstante, el usuario debe
                    ser consciente de que las medidas de seguridad en Internet
            ...
            <section className="">
                ...
                <div>
                    ...
                    de privacidad de dicho sitio web, quedando CERVEZANAS
                    desvinculada de cualquier tipo de responsabilidad acerca de
            ...
            <section className="">
                ...
                <div>
                    ...
                    el propio terminal del usuario, la información recogida
                    mediante las cookies sirve para facilitar la navegación del
                    usuario por el portal y optimizar la experiencia de
                    navegación. Los datos recopilados mediante las cookies
                    pueden ser compartidos con los creadores de las mismas, pero
                    en ningún caso la información obtenida por las mismas será
                    asociada a datos personales ni a datos que puedan
                ...
                <div>
                    ...
                    aquellas que no le interesen. Para obtener más información
