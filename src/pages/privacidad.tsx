  ...
  return (
    <Layout usePadding={true} useBackdrop={false}>
      <div>
        ...
        del RGPD te informamos de lo siguiente: Responsable PC COMPONENTES Y
        MULTIMEDIA S.L.U. (en adelante, PcComponentes) Avda. Europa, Parcelas
        2-5 y 2-6 Polígono Industrial Las Salinas, 30840 Alhama de Murcia,
        Teléfono de contacto: 968 977 977* ¿Qué hacemos con tus datos? -
        Apartado &quot;Nuevo Cliente&quot; La principal finalidad de dicho
        tratamiento es la gestión de los usuarios registrados en nuestra web,
        así como el envío de publicidad relativa a los productos y servicios
        comercializados por PcCOMPONENTES o para el envío de publicidad,
        descuentos y promociones de productos y servicios de otras
        entidades.PcCOMPONENTES asegura la confidencialidad de los datos
        aportados y garantiza que, en ningún caso, serán cedidos para ningún
        otro uso sin mediar consentimiento previo y expreso de nuestros
        ...
        Apartado &quot;Realizar Compra&quot; Al igual que indicamos en nuestra
        política de privacidad, la principal finalidad del tratamiento de los
        datos es mantener la relación contractual con nuestros clientes,
        facilitar la tramitación de los pedidos, la realización de estudios
        estadísticos, envío de publicidad relativa a los productos y servicios
        comercializados por PCCOMPONENTES o para el envío de publicidad,
        descuentos y promociones de productos y servicios de otras entidades, y
        además para el estudio de financiación de compras y obtención de
        créditos al consumo, así como para el descubrimiento y prevención del
        fraude, y minimización del riesgo de su comisión, en base al interés
        legítimo reconocido por la normativa vigente. - Apartado &quot;Boletín
        ofertas&quot; y &quot;Ofertas Express&quot; El e-mail facilitado será
        objeto de tratamiento por parte de PcCOMPONENTES con la finalidad de
        enviar el boletín de ofertas. Este Boletín tiene carácter exclusivamente
        informativo. - Acciones de Marketing. PcCOMPONENTES podrá utilizar
        dichos datos para informar sobre futuras promociones, ofertas y otras
        acciones comerciales en los casos en los que Vd. sea ya cliente o si no
        lo es, cuando Vd. nos haya proporcionado su consentimiento en el
        correspondiente apartado. - Apartado &quot;Formulario de Contacto y
        Centro de Soporte de PcCOMPONENTES&quot; Recogeremos datos con el fin de
        gestionar el centro de soporte de PcCOMPONENTES y el contacto con el
        cliente vía ticket a fin de poder atender su petición. Uso de los
        tickets Cada usuario puede acceder a sus tickets mediante usuario y
        contraseña. Las contraseñas son personales e intransferibles y el
        usuario es responsable del uso de sus contraseñas y de su comunicación a
        terceros. La información que contiene los tickets es de carácter
        confidencial. PcCOMPONENTES prohíbe la publicación de los tickets a
        terceros y de su divulgación en foros, redes sociales y cualquier sitio
        web. - Apartado &quot;Formulario RMA&quot; La principal finalidad de
        este tratamiento es la gestión del RMA (Uso de garantía de su
        producto).Sus datos pueden ser comunicados a los fabricantes en el
        supuesto de productos averiados o defectuosos. - Información recogida
        orientada a mejoras web Para mejorar nuestros servicios y la compra
        on-line estamos analizando el portal de PcComponentes y la correcta
        navegación del usuario. Esta información será confidencial y únicamente
        será utilizada para mejorar la seguridad y funcionamiento de nuestra
        tienda on-line y para fines estadísticos. Base jurídica de los
        tratamientos Para el registro, compra y la gestión de las garantías
        ...
        remitir los boletines y siempre con su consentimiento. PcCOMPONENTES
        ...
        dirección Av. Europa Parcela 2-3, Pol. Ind. Las Salinas 30840 Alhama de
        Murcia también a través de nuestro formulario o al correo electrónico
        lopd@pccomponentes.com. PcCOMPONENTES. El interesado también tiene
        derecho a presentar una reclamación ante las autoridades de protección
        de datos (Agencia Española de Protección de Datos). No obstante,
        cualquier cuestión relacionada con los datos le invitamos a contactar
        con nosotros para solucionarla. Delegado de protección de datos Hemos
        designado un delegado de protección de datos (DPO) para cualquier
        cuestión relacionada con sus datos personales. Puede contactar con él a
        través de la dirección lopd@pccomponentes.com Calidad de los datos Los
        ...
        Protección de los menores No recogemos datos personales de menores. Es
        ...
        que este lugar es independiente de la web www.PcComponentes.com y está
        ...
        Twitter o Youtube. PcCOMPONENTES no es titular de las redes sociales.
